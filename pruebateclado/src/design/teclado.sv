...
(
    ...
    always @(posedge clk) begin
        ...
        case (estado)
            ...
            SCAN_FIL : begin 
                if (filas_fil != 4'b0000) begin 
                    unique case({columnas,filas_fil})
                        // Columna C0
                        8'b1000_1000: boton <= 4'b0001; //1
                        8'b1000_0100: boton <= 4'b0100; //4
                        8'b1000_0010: boton <= 4'b0111; //7
                        8'b1000_0001: boton <= 4'b1101; //*

                        // Columna C1 (columnas=0100)
                        8'b0100_1000: boton <= 4'b0010; //2
                        8'b0100_0100: boton <= 4'b0101; //5
                        8'b0100_0010: boton <= 4'b1000; //8
                        8'b0100_0001: boton <= 4'b0000; //0

                        // Columna C2 (columnas=0010)
                        8'b0010_1000: boton <= 4'b0011; //3
                        8'b0010_0100: boton <= 4'b0110; //6
                        8'b0010_0010: boton <= 4'b1001; //9
                        8'b0010_0001: boton <= 4'b1110; //#

                        // Columna C3 (columnas=0001)
                        8'b0001_1000: boton <= 4'b0110; //A
                        8'b0001_0100: boton <= 4'b1011; //B
                        8'b0001_0010: boton <= 4'b1100; //C
                        8'b0001_0001: boton <= 4'b1101; //D
